//
//  LadderCollectionViewLayout.swift
//  Stanhope FNC
//
...
class LadderCollectionViewLayout: UICollectionViewLayout {
    ...
    override func prepare() {
            ...
            for section in 0...collectionView!.numberOfSections-1 {
                ...
                if (collectionView?.numberOfItems(inSection: section))! > 0 {
                    for item in 0...collectionView!.numberOfItems(inSection: section)-1 {
                        ...
                        var xPos = Double(item) * CELL_WIDTH
        ...
        // Update content size.
        let contentWidth = Double(collectionView!.numberOfItems(inSection: 0)) * CELL_WIDTH + 60.0
